...
class BusinessPlanTool(BaseTool):
        ...
        try:
            ...
            plan_data = { # type: ignore
                ...
                'sections': {
                    ...
                    'startup_checklist': self._generate_checklist(business_type), # type: ignore
                },
                'generated_at': datetime.utcnow().isoformat(), # type: ignore
    ...
    def _generate_checklist(self, business_type: str) -> list: # type: ignore
...
class ProposalTool(BaseTool):
        ...
        try:
            ...
            proposal_data = { # type: ignore
                ...
                'proposal_sections': {
                    ...
                    'deliverables': self._generate_deliverables(project_type), # type: ignore
            ...
            return ToolExecutionResult(
                tool_id=self.tool_id,
                success=True,
                data=proposal_data, # type: ignore
                execution_ms=int((time.time() - start_time) * 1000)
            )
    ...
    def _generate_deliverables(self, project_type: str) -> list: # type: ignore
...
class InvoiceTool(BaseTool):
        ...
        try:
            ...
            invoice_data = { # type: ignore
                ...
                'invoice_sections': {
                    ...
                    'line_items': self._generate_line_items(message), # type: ignore
                    'summary': {
                        'subtotal': '[Amount]',
                        'tax': '[Tax Amount]',
                        'total': '[Total Amount]'
    ...
    def _generate_line_items(self, message: str) -> list: # type: ignore
...
class MarketingTool(BaseTool):
    ...
    async def execute(self, context: Dict[str, Any]) -> ToolExecutionResult:
        ...
        try:
            ...
            marketing_data = { # type: ignore
                'business_type': business_type,
                'marketing_strategy': {
                    'positioning': self._generate_positioning(business_type),
                    'target_audience': self._generate_target_audience(business_type),
                    'channels': self._generate_channels(business_type), # type: ignore
                    'campaign_ideas': self._generate_campaigns(business_type), # type: ignore
                    'social_content': self._generate_social_ideas(business_type), # type: ignore
                    'growth_tactics': self._generate_growth_tactics(business_type), # type: ignore
                },
                'generated_at': datetime.utcnow().isoformat(), # type: ignore
                'execution_ms': int((time.time() - start_time) * 1000)
            }
            ...
            return ToolExecutionResult(
                tool_id=self.tool_id,
                success=True,
                data=marketing_data, # type: ignore
                execution_ms=int((time.time() - start_time) * 1000)
            )
    ...
    def _generate_channels(self, business_type: str) -> list: # type: ignore
    ...
    def _generate_campaigns(self, business_type: str) -> list: # type: ignore
    ...
    def _generate_social_ideas(self, business_type: str) -> Dict[str, list]: # type: ignore
    ...
    def _generate_growth_tactics(self, business_type: str) -> list: # type: ignore
...
def register_default_tools(registry): # type: ignore
    """Register all default business tools."""
    registry.register(BusinessPlanTool()) # type: ignore
    registry.register(ProposalTool()) # type: ignore
    registry.register(InvoiceTool()) # type: ignore
    registry.register(MarketingTool()) # type: ignore
    registry.register(ResearchCollectorTool()) # type: ignore
    registry.register(EmailDraftBuilderTool()) # type: ignore
    registry.register(BrowserOpenTool()) # type: ignore
    registry.register(WorkflowRunnerTool()) # type: ignore
    registry.register(MemoryLookupTool()) # type: ignore
